...
public class CmdCoreRawMessage extends Subcommand {
	...
	public static void parseAndRun(CommandSender s, String[] args) {
		...
		// message only
		if (offset == 0) {
			Util.msg(recipient, NeoCore.miniMessage().deserialize(SharedUtil.connectArgs(args)), false);
		}
		// message and page
		else if (offset == 1) {
			Util.msg(recipient, NeoCore.miniMessage().deserialize(SharedUtil.connectArgs(args, 1)), false);
		}
	}
}
