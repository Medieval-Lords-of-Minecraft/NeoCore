...
public class LocalAxes {
	...
	private static final LocalAxes XZ = new LocalAxes(new Vector(-1,0,0), new Vector(0,1,0), new Vector(0,0,1));
	...
	public boolean isXZ() {
		return this.left.getX() == -1 && this.up.getY() == 1;
	}
	...
	public static LocalAxes of(LivingEntity e) {
